...
if (new Date - user.lastmiming < 10000) return await conn.reply(m.chat, `*ESPERA UNOS MINUTOS PARA USAR OTRO COMANDO*`,  m)
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      if (!img) throw `╰⊱❗️⊱ *𝙇𝙊 𝙐𝙎𝙊́ 𝙈𝘼𝙇 | 𝙐𝙎𝙀𝘿 𝙄𝙏 𝙒𝙍𝙊𝙉𝙂* ⊱❗️⊱╮\n\n❗𝐸𝑅𝑅𝑂𝑅 ❗✞ 𝑅𝐸𝑆𝑃𝑂𝑁𝐷𝐴 𝐴 𝑈𝑁𝐴 𝐼𝑀𝐴𝐺𝐸𝑁-𝑉𝐼𝐷𝐸𝑂-𝐺𝐼𝐹 𝑂 𝐸𝑁𝐿𝐴𝐶𝐸 𝐷𝐸 𝑇𝐼𝑃𝑂 *.𝑗𝑝𝑔* 𝑃𝐴𝑅𝐴 𝑅𝐸𝐴𝐿𝐼𝑍𝐴𝑅 𝑆𝑇𝐼𝐶𝐾𝐸𝑅 ✞ *${usedPrefix + command}*`
      let out
      try {
    ...
    else throw '❗𝐸𝑅𝑅𝑂𝑅 ❗✞ 𝑅𝐸𝑆𝑃𝑂𝑁𝐷𝐴 𝐴 𝑈𝑁𝐴 𝐼𝑀𝐴𝐺𝐸𝑁-𝑉𝐼𝐷𝐸𝑂-𝐺𝐼𝐹 𝑂 𝐸𝑁𝐿𝐴𝐶𝐸 𝐷𝐸 𝑇𝐼𝑃𝑂 *.𝑗𝑝𝑔* 𝑃𝐴𝑅𝐴 𝑅𝐸𝐴𝐿𝐼𝑍𝐴𝑅 𝑆𝑇𝐼𝐶𝐾𝐸𝑅 ✞'
  }
