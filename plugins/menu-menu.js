...
{ comando: (m, chat) => m?.isGroup ? (chat.audios ? 'off ' : 'on ') + 'audios' : false, descripcion: (m, chat) =>  m?.isGroup ? (chat.audios ? '✅ ' + 'Activado || Activated' : '❌ ' + 'Desactivado || Disabled') : false, contexto: 'Audios automáticos en chats', showPrefix: false }, 
