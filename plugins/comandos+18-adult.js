...
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/nsfwloli.json`)).data  
...
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/nsfwfoot.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/nsfwass.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/nsfwbdsm.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/nsfwcum.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/nsfwero.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/nsfwfemdom.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
//await conn.sendButton(m.chat, lenguajeGB.smsCont18Porn(), ` *_${lenguajeGB['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeGB.smsSig(), `${usedPrefix + command}`], [lenguajeGB.lenguaje() == 'es' ? '🔞 ver lista porno 🔞'.toUpperCase() : '🔞 list horny🔞 '.toUpperCase(), lenguajeGB.lenguaje() == 'es' ? usedPrefix + 'listaporno' : usedPrefix + 'listhorny']], m, frep)}
  
if (command == 'pornoglass' || command == 'nsfwglass') {
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/nsfwglass.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/hentai.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/nsfworgy.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let resError = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/tetas.json`)).data   
...
let resError = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/booty.json`)).data   
...
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/ecchi.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
//await conn.sendButton(m.chat, lenguajeGB.smsCont18Porn(), ` *_${lenguajeGB['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeGB.smsSig(), `${usedPrefix + command}`], [lenguajeGB.lenguaje() == 'es' ? '🔞 ver lista porno 🔞'.toUpperCase() : '🔞 list horny🔞 '.toUpperCase(), lenguajeGB.lenguaje() == 'es' ? usedPrefix + 'listaporno' : usedPrefix + 'listhorny']], m, frep)}
  
if (command == 'pornofurro' || command == 'nsfwfurry') {
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/furro.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let resError = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/imagenlesbians.json`)).data   
...
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/panties.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let resError = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/pene.json`)).data   
...
let rawjsonn = ['https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/tetas.json', 'https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/booty.json', 'https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/imagenlesbians.json', 'https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/panties.json', 'https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/porno.json'] 
...
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/pechos.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let res = (await axios.get(`https://raw.githubusercontent.com/HasamiAini/wabot_takagisan/main/whatsapp%20bot%20takagisan/whatsapp%20bot%20takagisan/lib/Yaoi.json`)).data  //`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/yaoi.json`
let enlace = await res[Math.floor(res.length * Math.random())]
...
let res = (await axios.get(`https://raw.githubusercontent.com/ramiroiodice/GataBot-MD/master/src/JSON/yuri.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
