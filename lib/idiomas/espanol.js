...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE MYLINGBOT 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR MYLINGBOT 🐈`}
...
const smsSpromote = () => { return '*@user 𝘼𝙃𝙊𝙍𝘼 𝙀𝙎 𝙐𝙉 𝘼𝘿𝙈𝙄𝙉 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*'}
const smsSdemote = () => { return '*@user 𝘿𝙀𝙅𝘼 𝘿𝙀 𝙎𝙀𝙍 𝙐𝙉 𝘼𝘿𝙈𝙄𝙉 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*'}
...
const smsContacto3 = () => { return '👑 A TODOS ME LOS COMO'}
const smsContacto4 = () => { return 'GOLOSO OFC DE GB 🐈'}
const smsContacto5 = () => { return '🐣 ¿PUEDE LEVANTAR EL JABON?'}
const smsContacto6 = () => { return 'NO TENGO CP Y QUE?'}
const smsContacto7 = () => { return '🌎 GLOBAL COMO TU HERMANA'}
const smsContacto8 = () => { return 'SOY BOT OFICIAL 😼'}
